...
impl W {
    #[doc = "Bit 2 - DISFOLD"]
    #[inline(always)]
    pub fn disfold(&mut self) -> DisfoldW<'_, ActrlSpec> {
        DisfoldW::new(self, 2)
    }
    #[doc = "Bit 10 - FPEXCODIS"]
    #[inline(always)]
    pub fn fpexcodis(&mut self) -> FpexcodisW<'_, ActrlSpec> {
        FpexcodisW::new(self, 10)
    }
    #[doc = "Bit 11 - DISRAMODE"]
    #[inline(always)]
    pub fn disramode(&mut self) -> DisramodeW<'_, ActrlSpec> {
        DisramodeW::new(self, 11)
    }
    #[doc = "Bit 12 - DISITMATBFLUSH"]
    #[inline(always)]
    pub fn disitmatbflush(&mut self) -> DisitmatbflushW<'_, ActrlSpec> {
