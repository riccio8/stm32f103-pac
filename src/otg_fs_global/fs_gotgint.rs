...
impl W {
    #[doc = "Bit 2 - Session end detected"]
    #[inline(always)]
    pub fn sedet(&mut self) -> SedetW<'_, FsGotgintSpec> {
        SedetW::new(self, 2)
    }
    #[doc = "Bit 8 - Session request success status change"]
    #[inline(always)]
    pub fn srsschg(&mut self) -> SrsschgW<'_, FsGotgintSpec> {
        SrsschgW::new(self, 8)
    }
    #[doc = "Bit 9 - Host negotiation success status change"]
    #[inline(always)]
    pub fn hnsschg(&mut self) -> HnsschgW<'_, FsGotgintSpec> {
        HnsschgW::new(self, 9)
    }
    #[doc = "Bit 17 - Host negotiation detected"]
    #[inline(always)]
    pub fn hngdet(&mut self) -> HngdetW<'_, FsGotgintSpec> {
        HngdetW::new(self, 17)
    }
    #[doc = "Bit 18 - A-device timeout change"]
    #[inline(always)]
    pub fn adtochg(&mut self) -> AdtochgW<'_, FsGotgintSpec> {
        AdtochgW::new(self, 18)
    }
    #[doc = "Bit 19 - Debounce done"]
    #[inline(always)]
    pub fn dbcdne(&mut self) -> DbcdneW<'_, FsGotgintSpec> {
        DbcdneW::new(self, 19)
    }
}
