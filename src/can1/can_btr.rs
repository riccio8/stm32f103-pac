...
impl W {
    #[doc = "Bits 0:9 - BRP"]
    #[inline(always)]
    pub fn brp(&mut self) -> BrpW<'_, CanBtrSpec> {
        BrpW::new(self, 0)
    }
    #[doc = "Bits 16:19 - TS1"]
    #[inline(always)]
    pub fn ts1(&mut self) -> Ts1W<'_, CanBtrSpec> {
        Ts1W::new(self, 16)
    }
    #[doc = "Bits 20:22 - TS2"]
    #[inline(always)]
    pub fn ts2(&mut self) -> Ts2W<'_, CanBtrSpec> {
        Ts2W::new(self, 20)
    }
    #[doc = "Bits 24:25 - SJW"]
    #[inline(always)]
    pub fn sjw(&mut self) -> SjwW<'_, CanBtrSpec> {
        SjwW::new(self, 24)
    }
    #[doc = "Bit 30 - LBKM"]
    #[inline(always)]
    pub fn lbkm(&mut self) -> LbkmW<'_, CanBtrSpec> {
        LbkmW::new(self, 30)
    }
    #[doc = "Bit 31 - SILM"]
    #[inline(always)]
    pub fn silm(&mut self) -> SilmW<'_, CanBtrSpec> {
        SilmW::new(self, 31)
    }
}
