...
impl W {
    #[doc = "Bit 0 - INRQ"]
    #[inline(always)]
    pub fn inrq(&mut self) -> InrqW<'_, CanMcrSpec> {
        InrqW::new(self, 0)
    }
    #[doc = "Bit 1 - SLEEP"]
    #[inline(always)]
    pub fn sleep(&mut self) -> SleepW<'_, CanMcrSpec> {
        SleepW::new(self, 1)
    }
    #[doc = "Bit 2 - TXFP"]
    #[inline(always)]
    pub fn txfp(&mut self) -> TxfpW<'_, CanMcrSpec> {
        TxfpW::new(self, 2)
    }
    #[doc = "Bit 3 - RFLM"]
    #[inline(always)]
    pub fn rflm(&mut self) -> RflmW<'_, CanMcrSpec> {
        RflmW::new(self, 3)
    }
    #[doc = "Bit 4 - NART"]
    #[inline(always)]
    pub fn nart(&mut self) -> NartW<'_, CanMcrSpec> {
        NartW::new(self, 4)
    }
    #[doc = "Bit 5 - AWUM"]
    #[inline(always)]
    pub fn awum(&mut self) -> AwumW<'_, CanMcrSpec> {
        AwumW::new(self, 5)
    }
    #[doc = "Bit 6 - ABOM"]
    #[inline(always)]
    pub fn abom(&mut self) -> AbomW<'_, CanMcrSpec> {
        AbomW::new(self, 6)
    }
    #[doc = "Bit 7 - TTCM"]
    #[inline(always)]
    pub fn ttcm(&mut self) -> TtcmW<'_, CanMcrSpec> {
        TtcmW::new(self, 7)
    }
    #[doc = "Bit 15 - RESET"]
    #[inline(always)]
    pub fn reset(&mut self) -> ResetW<'_, CanMcrSpec> {
        ResetW::new(self, 15)
    }
    #[doc = "Bit 16 - DBF"]
    #[inline(always)]
    pub fn dbf(&mut self) -> DbfW<'_, CanMcrSpec> {
        DbfW::new(self, 16)
    }
}
