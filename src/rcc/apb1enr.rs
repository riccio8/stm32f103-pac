...
impl W {
    ...
    #[doc = "Bit 3 - Timer 5 clock enable"]
    #[inline(always)]
    pub fn tim5en(&mut self) -> Tim5enW<'_, Apb1enrSpec> {
        Tim5enW::new(self, 3)
    }
    #[doc = "Bit 4 - Timer 6 clock enable"]
    #[inline(always)]
    ...
    #[doc = "Bit 6 - Timer 12 clock enable"]
    #[inline(always)]
    pub fn tim12en(&mut self) -> Tim12enW<'_, Apb1enrSpec> {
        Tim12enW::new(self, 6)
    }
    #[doc = "Bit 7 - Timer 13 clock enable"]
    #[inline(always)]
    pub fn tim13en(&mut self) -> Tim13enW<'_, Apb1enrSpec> {
        Tim13enW::new(self, 7)
    }
    #[doc = "Bit 8 - Timer 14 clock enable"]
    #[inline(always)]
    pub fn tim14en(&mut self) -> Tim14enW<'_, Apb1enrSpec> {
        Tim14enW::new(self, 8)
    }
    #[doc = "Bit 11 - Window watchdog clock enable"]
    #[inline(always)]
    ...
    #[doc = "Bit 19 - UART 4 clock enable"]
    #[inline(always)]
    pub fn uart4en(&mut self) -> Uart4enW<'_, Apb1enrSpec> {
        Uart4enW::new(self, 19)
    }
    #[doc = "Bit 20 - UART 5 clock enable"]
    #[inline(always)]
    pub fn uart5en(&mut self) -> Uart5enW<'_, Apb1enrSpec> {
    ...
    #[doc = "Bit 27 - Backup interface clock enable"]
    #[inline(always)]
    pub fn bkpen(&mut self) -> BkpenW<'_, Apb1enrSpec> {
        BkpenW::new(self, 27)
    }
    #[doc = "Bit 28 - Power interface clock enable"]
    #[inline(always)]
